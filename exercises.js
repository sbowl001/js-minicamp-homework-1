...
function square(num) {
  ...
  return result;// square num and return the new value
  // code here
}

function cube(num) {
  var result = Math.pow( num, 3);
  return result; // cube num and return the new value
  // code here
}

function raiseToPower(num, exponent) {
  var result = Math.pow( num, exponent); 
  return result;// raise num to whatever power is passed in as exponent
  // code here
}
...
function getCircleArea(radius) {
  ...
  return Math.round(area); // return the rounded area of the circle given the radius
  // code here
}
